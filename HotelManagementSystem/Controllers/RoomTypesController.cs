...
namespace HotelManagementSystem.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,Name")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Price,Name")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
